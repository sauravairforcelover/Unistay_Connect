          ...
          {bookings.length === 0 && !loading && (
            <div className="p-4">
              <div className="text-center py-12">
                ...
                <p className="text-[#617589] text-lg mb-2">No bookings yet</p>
                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundImage: `url(${booking.property.images[0] || "https://via.placeholder.com/300"})`,
                        }}
                      ></div>
                    </Link>
                    <div className="flex-1 flex flex-col gap-2">
                      ...
                      <div className="flex gap-2 mt-auto">
                        ...
                        {booking.status === "approved" && (
                          <Link
                            href={`/messages?receiverId=${booking.propertyId}`}
